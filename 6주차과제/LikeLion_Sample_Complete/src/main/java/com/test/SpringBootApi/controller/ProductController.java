...
public class ProductController {
    ...
    public ResponseEntity<List<ProductReturnDto>> searchProducts(@RequestParam("productName") String productName){
        try{
            List<ProductReturnDto> productReturnDtoList = productService.searchProducts(productName);
